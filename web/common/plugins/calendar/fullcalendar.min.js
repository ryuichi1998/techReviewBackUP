...
!function (t) {
    ...
    function yt(t) {
        for (var e, n = [], i = /\[([^\]]*)\]|\(([^\)]*)\)|(LTS|LT|(\w)\4*o?)|([^\w\[\(]+)/g; e = i.exec(t);)e[1] ? n.push(e[1]) : e[2] ? n.push({maybe: yt(e[2])}) : e[3] ? n.push({token: e[3]}) : e[5] && n.push(e[5]);
        return n
    }
    ...
    function _t(n, i) {
        ...
        function o() {
            n.addClass("fc"), n.on("click.fc", "a[data-goto]", function (e) {
                var n = t(this), i = n.data("goto"), r = _.moment(i.date), s = i.type, o = Q.opt("navLink" + rt(s) + "Click");
        ...
        function g() {
            var t = _.options.contentHeight, e = _.options.height;
        ...
        _.bindOptions(["locale", "monthNames", "monthNamesShort", "dayNames", "dayNamesShort", "firstDay", "weekNumberCalculation"], function (t, e, n, i, s, o, l) {
            ...
            var e, n = _.moment(t.toArray()), i = t.time() - n.time();
        ...
        var W, U, j, q, $, Q, X, K, J, tt = n[0], et = {}, nt = 0;
    ...
    function Ut() {
        ...
        function f(e, n) {
            ...
            if (o) t.isFunction(o) ? (U.pushLoading(), o.call(U, q.clone(), Z.clone(), U.options.timezone, function (t) {
                ...
                if (l) {
                    ...
                    var h = t.extend({}, a || {}), g = J(e.startParam, U.options.startParam), p = J(e.endParam, U.options.endParam), v = J(e.timezoneParam, U.options.timezoneParam);
        ...
        function L(t, e) {
            var n, r, s, o, l, a = [];
            for (s = 0; s < t.length; s++)if (r = F(t[s])) {
        ...
        function _(e, n, i) {
            ...
            if (n = n || q, i = i || Z, e)if (e._recurring) {
    ...
    var qt = t.fullCalendar = {version: "3.1.0", internalApiVersion: 7}, Zt = qt.views = {};
    ...
    var Xt = ["sun", "mon", "tue", "wed", "thu", "fri", "sat"], Kt = ["year", "month", "week", "day", "hour", "minute", "second", "millisecond"];
    qt.log = function () {
    ...
    qt.createObject = Z;
    var te = /^\s*\d{4}-\d\d$/, ee = /^\s*\d{4}-(?:(\d\d-\d\d)|(W\d\d$)|(W\d\d-\d)|(\d\d\d))((T| )(\d\d(:\d\d(:\d\d(\.\d+)?)?)?)?)?$/, ne = e.fn, ie = t.extend({}, ne), re = e.momentProperties;
    ...
    qt.queryMostGranularFormatUnit = function (t) {
        ...
        var n, i, r, s = !1;
        if (bt.immediate)for (s = !0, n = [], i = 0; i < e.length; i++)if (r = e[i], r && "function" == typeof r.state && "resolved" === r.state() && "_value" in r) n.push(r._value); else {
    ...
    var ue = qt.EmitterMixin = {
        ...
        isIgnoringMouse: !1, delayUnignoreMouse: null, initMouseIgnoring: function (t) {
    ...
    var pe = ge.extend({
        ...
        dayTouchStart: function (t) {
            var e = this.view, n = e.opt("selectLongPressDelay");
        ...
        buildDayDragListener: function () {
            var t, e, n = this, i = this.view, r = i.opt("selectable"), l = new pe(this, {
        ...
        getDayClasses: function (t, e) {
            var n = this.view, i = n.calendar.getNow(), r = ["fc-" + Xt[t.day()]];
    ...
    me.mixin({
        ...
        handleSegTouchStart: function (t, e) {
            var n, i, r = this.view, s = t.event, o = r.isEventSelected(s), l = r.isEventDraggable(s), a = r.isEventResizable(s), u = !1;
        ...
        listenToExternalDrag: function (t, e, n) {
            var i, r = this, l = this.view.calendar, a = Mt(t), u = r.externalDragListener = new pe(this, {
                interactionStart: function () {
        ...
        buildSegResizeListener: function (t, e) {
            var n, i, r = this, l = this.view, a = l.calendar, u = t.el, c = t.event, d = a.getEventEnd(c), h = this.segResizeListener = new pe(this, {
                scroll: l.opt("dragScroll"),
                subjectEl: u,
                interactionStart: function () {
                    n = !1
    ...
    var ye = qt.DayTableMixin = {
        ...
        renderHeadDateCellHtml: function (t, e, n) {
            var i = this.view, r = ["fc-day-header", i.widgetHeaderClass];
        ...
        renderNumberCellHtml: function (t) {
            ...
            return this.view.dayNumbersVisible || this.view.cellWeekNumbersVisible ? (e = this.getDayClasses(t), e.unshift("fc-day-top"), this.view.cellWeekNumbersVisible && (n = "ISO" === t._locale._fullCalendar_weekCalc ? 1 : t._locale.firstDayOfWeek()), i += '<td class="' + e.join(" ") + '" data-date="' + t.format() + '">', this.view.cellWeekNumbersVisible && t.day() == n && (i += this.view.buildGotoAnchorHtml({
                date: t,
                type: "week"
            }, {class: "fc-week-number"}, t.format("w"))), this.view.dayNumbersVisible && (i += this.view.buildGotoAnchorHtml(t, {class: "fc-day-number"}, t.date())), i += "</td>") : "<td/>"
        },
        computeEventTimeFormat: function () {
    ...
    var we = qt.TimeGrid = me.extend(ye, {
        ...
        renderDates: function () {
            this.el.html(this.renderHtml()), this.colEls = this.el.find(".fc-day"), this.slatContainerEl = this.el.find(".fc-slats"), this.slatEls = this.slatContainerEl.find("tr"), this.colCoordCache = new fe({
                els: this.colEls,
                isHorizontal: !0
            }), this.slatCoordCache = new fe({els: this.slatEls, isVertical: !0}), this.renderContentSkeleton()
        },
        renderHtml: function () {
    ...
    var De = qt.Calendar = St.extend({
        ...
        getUnitViewSpec: function (e) {
            var n, i, r;
            if (t.inArray(e, Kt) != -1)for (n = this.header.getViewsWithButtons(), t.each(qt.views, function (t) {
                n.push(t)
            }), i = 0; i < n.length; i++)if (r = this.getViewSpec(n[i]), r && r.singleUnit == e)return r
        },
        buildViewSpec: function (t) {
            for (var i, r, s, o, l = this.overrides.views || {}, a = [], u = [], c = [], d = t; d;)i = Zt[d], r = l[d], d = null, "function" == typeof i && (i = {class: i}), i && (a.unshift(i), u.unshift(i.defaults || {}), s = s || i.duration, d = d || i.type), r && (c.unshift(r), s = s || r.duration, d = d || r.type);
    ...
    Zt.basic = {class: Le}, Zt.basicDay = {type: "basic", duration: {days: 1}}, Zt.basicWeek = {
        type: "basic",
        duration: {weeks: 1}
    ...
    }, Ge = 5, Oe = [{hours: 1}, {minutes: 30}, {minutes: 15}, {seconds: 30}, {seconds: 15}];
    Zt.agenda = {
        class: ze,
        defaults: {
            allDaySlot: !0,
    ...
    }, Zt.agendaDay = {type: "agenda", duration: {days: 1}}, Zt.agendaWeek = {type: "agenda", duration: {weeks: 1}};
    var Ae = Ee.extend({
    ...
    }, Zt.listDay = {type: "list", duration: {days: 1}, defaults: {listDayFormat: "dddd"}}, Zt.listWeek = {
        type: "list",
        duration: {weeks: 1},
    ...
    }, Zt.listYear = {type: "list", duration: {year: 1}, defaults: {listDayAltFormat: "dddd"}}, qt
});