                                ...
                                <div class="box-body">
                                    ...
                                    <div class="col col-md-9">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="field"><input type="text" class="form-control" placeholder="Subject title" id="subjecttitle" name="subjecttitle">
                                                <i></i></div>
                                        </div>

                                        <div class="form-group">
                                            <label>Short description</label>
                                            <div class="field"><input type="text" class="form-control" placeholder="Enter short description" name="shortdesc" id="shortdesc" maxlength="45">
                                                <i></i></div>
                                        </div>

                                        <div class="form-group">
                                            <label>Article Description</label>
                                            <textarea class="form-control textarea" name="longdesc" placeholder="Place some text here" style="width: 100%; height: 200px; font-size: 14px; line-height: 18px; border: 1px solid #dddddd; padding: 10px;"></textarea>
                                        </div>
